alias CineasteData.{AuthorWork,Film,FilmWork,Label,Person,Publisher,Repo,Studio,StudioWork,Work}
...
label_attrs = [
  ...
  %{slug: "young-magazine-pirated-edition", name: "Young Magazine Pirated Edition", publisher: "kodansha"},
...
works_attrs = [
  ...
  %{slug: "20th-century-boys", format: :manga, title: "20th Century Boys", authors: ["urasawa-naoki"], publisher: "shogakukan", label: "big-spirits-comics"},
  %{slug: "21st-century-boys", format: :manga, title: "20th Century Boys", authors: ["urasawa-naoki"], publisher: "shogakukan", label: "big-spirits-comics"},
  %{slug: "man-they-called-pirate", format: :novel, title: "The Man They Called Pirate", authors: ["hyakuta-naoki"], publisher: "kodansha"},
  ...
  %{slug: "akira", format: :manga, title: "Akira", authors: ["otomo-katsuhiro"], publisher: "kodansha", label: "young-magazine"},
  %{slug: "alive", format: :manga, title: "Alive", authors: ["takahashi-tsutomu"], publisher: "shueisha", label: "young-jump"},
  %{slug: "all-round-appraiser-qs-case-files", format: :"novel series", title: "All-Round Appraiser Q's Case Files", authors: ["matsuoka-keisuke"], publisher: "kadokawa-shoten"},
  %{slug: "sunset-on-third-street", format: :manga, title: "Sunset on Third Street", authors: ["saigan-ryohei"], publisher: "shogakukan", label: "big-comic-original"},
  %{slug: "assassination-classroom", format: :manga, title: "Assassination Classroom", authors: ["matsui-yusei"], publisher: "shueisha", label: "weekly-shonen-jump"},
  %{slug: "undersea-warship", format: :novel, title: "Undersea Warship", authors: ["oshikawa-shunro"]},
  %{slug: "attack-on-titan", format: :manga, title: "Attack on Titan", authors: ["isayama-hajime"], publisher: "kodansha", label: "bessatsu-shonen-magazine"},
  %{slug: "azumi", format: :manga, title: "Azumi", authors: ["koyama-yu"], publisher: "shogakukan", label: "big-comic-superior"},
  %{slug: "crayon-shin-chan-fierceness-that-invites-storm-the-battle-of-the-warring-states", format: :screenplay, title: "Crayon Shin-chan: Fierceness That Invites Storm! The Battle of the Warring States", authors: ["usui-yoshito", "hara-keiichi"] },
  %{slug: "battle-royale", format: :novel, title: "Battle Royale", authors: ["takami-koshun"], publisher: "ota-shoten"},
  %{slug: "casshern", format: :anime, title: "Casshern", studios: ["tatsunoko-productions"]},
  %{slug: "hatobueso", format: :novel, title: "Hatobuesō", authors: ["miyabe-miyuki"], publisher: "kobunsha"},
  %{slug: "crossfire", format: :novel, title: "Crossfire", authors: ["miyabe-miyuki"], publisher: "kobunsha"},
  %{slug: "daredevil-in-the-castle", format: :"serialized novel", authors: ["murakami-genzo"], publisher: "kobunsha", label: "weekly-asahi"},
  %{slug: "death-note", format: :manga, title: "Death Note", authors: ["oba-tsugumi", "obata-takeshi"], publisher: "shueisha", label: "jump-comics"},
  %{slug: "space-mons", format: :screenplay, title: "Space Mons", authors: ["okami-jojiro"]},
  %{slug: "dororo", format: :manga, title: "Dororo", authors: ["tezuka-osamu"], publisher: "shogakukan", label: "weekly-shonen-sunday"},
  %{slug: "eko-eko-azarak", format: :manga, title: "Eko Eko Azarak", authors: ["koga-shinichi"], publisher: "akita-shoten", label: "weekly-shonen-champion"},
  %{slug: "espy", format: :novel, title: "ESPY", authors: ["komatsu-sakyo"], publisher: "hayakawa-publishing"},
  %{slug: "eternal-zero", format: :novel, title: "The Eternal Zero", authors: ["hyakuta-naoki"], publisher: "ota-shuppan"},
  %{slug: "criticality-of-explosion", format: :novel, title: "The Criticality of Explosion", authors: ["tanaka-koji"], publisher: "shodensha"},
  %{slug: "sengoku-self-defense-force", format: :"serialized novel", title: "Sengoku Self Defense Force", authors: ["hanmura-ryo"], publisher: "sf-magazine"},
  %{slug: "sengoku-self-defense-force-1549", format: :novel, title: "Sengoku Self Defense Force 1549", authors: ["fukui-harutoshi"], publisher: "kadokawa-shoten"},
  %{slug: "gantz", format: :manga, title: "Gantz", authors: ["oku-hiroya"], publisher: "shueisha", label: "weekly-young-jump"},
  %{slug: "science-ninja-team-gatchaman", format: :anime, title: "Science Ninja Team Gatchaman", studios: ["tatsunoko-productions"]},
  %{slug: "to-the-ends-of-the-earth-and-sea", format: :novel, title: "To the Ends of the Earth and Sea: A Novel of Genghis Khan", authors: ["morimura-seiichi"], publisher: "kadokawa-shoten"},
  %{slug: "ghost-in-the-shell", format: :manga, title: "Ghost in the Shell", authors: ["masamune-shiro"], publisher: "kodansha", label: "young-magazine-pirated-edition"},
  %{slug: "glorious-team-batista", format: :novel, title: "The Glorious Team Batista", authors: ["kaido-takeru"], publisher: "takarajimasha"},
  %{slug: "gods-left-hand-devils-right-hand", format: :manga, title: "God's Left Hand, Devil's Right Hand", authors: ["umezu-kazuo"], publisher: "shogakukan", label: "big-spirits-comics"},
  %{slug: "monster-godzilla", format: :"serialized novel", title: "Monster Godzilla", authors: ["kayama-shigeru"]},
  %{slug: "golden-bat", format: :"picture story", authors: ["nagamatsu-takeo"], publisher: "meiseisha"},
  %{slug: "strange-ronin", format: :novel, title: "Strange Ronin", authors: ["takiguchi-yasuhiko"]},
  %{slug: "kings-ransom", format: :novel, title: "King's Ransom", authors: ["mcbain-ed"], publisher: "simon-schuster"},
  %{slug: "howls-moving-castle", format: :novel, title: "Howl's Moving Castle", authors: ["jones-diana-wynn"], year: 1986, publisher: "greenwillow"},
  %{slug: "i-am-a-hero", format: :manga, title: "I Am A Hero", authors: ["hanazawa-kengo"], publisher: "shogakukan", label: "big-spirits-comics"},
  %{slug: "kerberos-panzer-cop", format: :manga, title: "Kerberos Panzer Cop", authors: ["oshii-mamoru"]},
  %{slug: "fiend-with-twenty-faces", format: :novel, title: "The Fiend with Twenty Faces", authors: ["kitamura-so"]},
  %{slug: "kaiji", format: :manga, title: "Kaiji", authors: ["fukumoto-nobuyuki"], publisher: "kodansha", label: "yanmaga-kc"},
  %{slug: "kamui-gaiden", format: :manga, title: "Kamui Gaiden", authors: ["shirato-sanpei"], publisher: "shogakukan"},
  %{slug: "new-legend-of-the-eight-samurai", format: :novel, title: "New Legend of the Eight Samurai", authors: ["kamata-toshio"], publisher: "kadokawa-shoten"},
  %{slug: "library-wars", format: :manga, title: "Library Wars", authors: ["takami-yu"], publisher: "kadokawa-shoten"},
  %{slug: "lorelei-at-the-end-of-the-war", format: :novel, title: "Lorelei at the End of the War", authors: ["fukui-harutoshi"], publisher: "kodansha"},
  ...
  %{slug: "voice-in-the-night", format: :"short story", title: "A Voice in the Night", authors: ["hodgson-william-hope"], year: 1907},
  %{slug: "mothra", format: :"original story", authors: ["nakamura-shinichiro", "fukunaga-takehiko", "hotta-yoshie"], publisher: "weekly-asahi"},
  %{slug: "mushi-shi", format: :manga, title: "Mushi-shi", authors: ["urushibara-yuki"], publisher: "kodansha", label: "afternoon"},
  %{slug: "earth-defense-force", format: :"unpublished novel", title: "Earth Defense Force", authors: ["okami-jojiro"]},
  %{slug: "one-missed-call", format: :"novel series", title: "One Missed Call", authors: ["akimoto-yasushi"], publisher: "kadokawa-shoten"},
  %{slug: "onmyoji", format: :"novel series", title: "Onmyoji", authors: ["yumemakura-baku"], publisher: "bungeishunju"},
  %{slug: "parasite-eve", format: :novel, title: "Parasite Eve", authors: ["sena-hideaki"], publisher: "kadokawa-shoten"},
  %{slug: "parasyte", format: :manga, title: "Parasyte", authors: ["iwaaki-hitoshi"], publisher: "kodansha"},
  %{slug: "platinum-data", format: :novel, title: "Platinum Data", authors: ["higashino-keigo"], publisher: "gotensha"},
  %{slug: "lady-snowblood", format: :manga, title: "Lady Snowblood", authors: ["koike-kazuo", "kamimura-kazuo"], publisher: "weekly-playboy"},
  %{slug: "great-prophecy-of-nostradamus", format: :novel, title: "The Great Prophecy of Nostradamus", authors: ["goto-ben"], publisher: "shodensha"},
  %{slug: "spiral", format: :novel, title: "Spiral", authors: ["suzuki-koji"], publisher: "kadokawa-shoten"},
  %{slug: "in-a-grove", format: :"short story", title: "In a Grove", authors: ["akutagawa-ryunosuke"]},
  %{slug: "rashomon", format: :"short story", title: "Rashomon", authors: ["akutagawa-ryunosuke"]},
  %{slug: "yomigaeru-sora-rescue-wings", format: :anime, title: "Yomigaeru Sora Rescue Wings", studios: ["bandai-visual"]},
  %{slug: "rescue-wings", format: :manga, title: "Rescue Wings", authors: ["otsuka-tommy"], publisher: "media-factory"},
  %{slug: "ring", format: :novel, title: "Ring", authors: ["suzuki-koji"], publisher: "kadokawa-shoten"},
  %{slug: "lemon-heart", format: :"short story", title: "Lemon Heart", authors: ["suzuki-koji"], publisher: "kadokawa-shoten"},
  %{slug: "rurouni-kenshin", format: :manga, title: "Rurouni Kenshin: Meiji Swordsman Romantic Story", authors: ["watsuki-nobuhiro"], publisher: "shueisha", label: "jump-comics"},
  %{slug: "musashi-miyamoto", format: :"serialized novel", title: "Musashi Miyamoto", authors: ["yoshikawa-eiji"], publisher: "asahi-shimbun"},
  %{slug: "everyday-peace", format: :screenplay, title: "Everyday Peace", authors: ["yamamoto-shuguro"]},
  %{slug: "koga-ninja-scroll", format: :"serialized novel", title: "Kōga Ninja Scroll", authors: ["yamada-futaro"], publisher: "kobunsha", label: "interesting-club"},
  %{slug: "sinking-of-japan", format: :novel, title: "The Sinking of Japan", authors: ["komatsu-sakyo"], publisher: "kobunsha", label: "kappa-novels"},
  %{slug: "sky-crawlers", format: :"novel series", title: "The Sky Crawlers", authors: ["mori-hiroshi"]},
  %{slug: "sky-high", format: :manga, title: "Shy High", authors: ["takahashi-tsutomu"], publisher: "shueisha", label: "weekly-young-jump"},
  %{slug: "space-battleship-yamato", format: :anime, title: "Space Battleship Yamato", authors: ["nishizaki-yoshinobu"]},
  %{slug: "doraemon", format: :manga, title: "Doraemon", authors: ["fujiko-f-fujio"], publisher: "shogakukan"},
  %{slug: "sword-of-the-emperor", format: :"serialized novel", title: "The Sword of the Emperor", authors: ["yumemakura-baku"], publisher: "kadokawa-shoten", label: "wild-age"},
  %{slug: "tetsujin-28", format: :manga, title: "Tetsujin-28", authors: ["yokoyama-mitsuteru"], publisher: "kobunsha", label: "sunday-comics"},
  %{slug: "disappearance-of-the-capital", format: :"serialized novel", title: "The Disappearance of the Capital", authors: ["komatsu-sakyo"]},
  %{slug: "himitsu-top-secret", format: :manga, title: "Himitsu: Top Secret", authors: ["shimizu-reiko"], publisher: "hakusensha", label: "melody"},
  %{slug: "triumphant-return-of-general-rouge", format: :novel, title: "The Triumphant Return of General Rouge", authors: ["kaido-takeru"], publisher: "takarajimasha"},
  %{slug: "warrior-spirit-great-tornado", format: :novel, title: "Warrior Spirit: Great Tornado", authors: ["nanjo-norio"]}
]
...
films_works_attrs = [
  ...
  %{film_slug: "20th-century-boys-1-the-beginning-of-the-end-2008", work_slug: "20th-century-boys"},
  ...
  %{film_slug: "all-round-appraiser-q-the-eyes-of-mona-lisa-2014", work_slug: "all-round-appraiser-qs-case-files"},
  %{film_slug: "atragon-1963", work_slug: "undersea-warship"},
  %{film_slug: "ballad-2009", work_slug: "crayon-shin-chan-fierceness-that-invites-storm-the-battle-of-the-warring-states"},
  ...
  %{film_slug: "genghis-khan-to-the-ends-of-the-earth-and-sea-2007", work_slug: "to-the-ends-of-the-earth-and-sea"},
  ...
  %{film_slug: "gods-left-hand-devils-right-hand-2006", work_slug: "gods-left-hand-devils-right-hand"},
  ...
  %{film_slug: "lorelei-the-witch-of-the-pacific-ocean-2005",  work_slug: "lorelei-at-the-end-of-the-war"},
  ...
  %{film_slug: "samurai-commando-mission-1549-2005", work_slug: "sengoku-self-defense-force-1549"},
  ...
  %{film_slug: "triumphant-return-of-general-rouge-2009", work_slug: "triumphant-return-of-general-rouge"},
